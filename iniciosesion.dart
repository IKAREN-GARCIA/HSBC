          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                fit: BoxFit.cover,
                image: Image.asset(
                  'assets/images/img_digital_product.png',
                ).image,
              ),
            ),
            child: Padding(
                      ...
                      child: Column(
                        children: [
                          TabBar(
                            ...
                            labelStyle: temasycolores.of(context).subtitle1,
                                            ...
                                            options: FFButtonOptions(
                                              ...
                                              color:
                                                  temasycolores.of(context)
                                                      .primaryBtnText,
                                              textStyle: temasycolores.of(
                                                      context)
                                                  .subtitle2
                                                  .override(
                                                    fontFamily: 'Lexend Deca',
                                                    color: temasycolores.of(
                                                            context)
                                                        .black600,
                                                    fontSize: 16,
                                                    fontWeight:
